...
?><span class="hidden" id="item<?=$value->id;?>"><?=$value->description;?></span><?php
        endforeach;
        echo form_dropdown('item_id', $options, '', ' class="chosen-select description-setter required" ');?>
...
<?php } ?>
 <div class="form-group">
        ...
        <input id="amount" type="number" min="0" name="amount" class="required form-control number"  value="<?php if(isset($estimate_has_items)){ echo $estimate_has_items->amount; }else{echo '1';} ?>"  />
 </div>
 <div class="form-group">
