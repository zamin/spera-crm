...
<div class="ajax-loader"></div>
	...
	<div class="modal-footer">
		<input type="submit" id="sub_submit" name="send" class="btn btn-primary" value="<?=$this->lang->line('application_save');?>"/>
...
$(document).ready(function(){
   ...
   $('#_subcontractor #sub_submit').on('click', function () {
   ...
   $('#_subcontractor').on('blur','#c_text',function(){
        ...
        if(sub_company !='')
        {
            ...
            else
            {
                ...
                $.ajax({
                   type:"GET",
                   cache:false,
                   url:"<?php echo base_url(); ?>subcontractors/company_name_check",
