  ...
  <div class="grid__col-md-7 dashboard-header">
    ...
    <div class="grid__col-sm-12 grid__col-md-8 grid__col-lg-9 grid__col--bleed">
      <div class="grid grid--align-content-start"> 
        <div class="grid__col-12 grid__col-xs-12 grid__col-sm-12  grid__col-md-12 grid__col-lg-12">
            <a href="<?=base_url();?>scprojects/filter/open" class="tile-base"> 
                                    ...
                                    <li class="<?=$value->status;?> priority<?=$value->priority;?> list-item">
                                        <span class="lbl-"> 
                                            <p class="truncate"><input name="form-field-checkbox" type="checkbox" class="checkbox-nolabel task-check" data-link="<?=base_url()?>projects/tasks/<?=$value->project_id;?>/check/<?=$value->id;?>" <?=$value->status;?>/>
                                                <a href="<?=base_url()?>scprojects/view/<?=$value->project_id;?>"><?=$value->name;?></a>
                                            </p>
                                        </span> 
                                        <span class="pull-right hidden-xs" style="margin-top: -43px;">
                                              
                                              <a href="<?=base_url()?>scprojects/tasks/<?=$value->project_id;?>/update/<?=$value->id;?>" class="edit-button" data-toggle="mainmodal"><i class="fa fa-cog"></i></a>
                                        </span>
                                    </li>
                                    <?php 
                                    endforeach;
        ...
        <div class="grid__col-12">
                    ...
                    <div class="stdpad stdpad--auto-height"><div class="table-head"><?=$this->lang->line('application_new_tickets');?></div>
                        <div class="table-div">
                            <table class="data-sorting table" id="sctickets" rel="<?=base_url()?>" cellspacing="0" cellpadding="0">
    <thead>
