                                ...
                                <ul id="jp-container" class="todo jp-container">
                                    ...
                                    <li class="<?=$value->status;?> priority<?=$value->priority;?> list-item">
                                        ...
                                        <span class="pull-right hidden-xs" style="margin-top: -43px;">
                                              ...
                                              <a href="<?=base_url()?>projects/tasks/<?=$value->project_id;?>/update/<?=$value->id;?>" class="edit-button" data-toggle="mainmodal"><i class="fa fa-cog"></i></a>
                                        </span>
                                    </li>
                                    <?php 
                                    endforeach;
                    ...
                    <div class="stdpad stdpad--auto-height"><div class="table-head"><?=$this->lang->line('application_new_tickets');?></div>
                        <div class="table-div">
                            ...
                            <tr id="<?=$value->id;?>" >
                              ...
                              <td><?=$value->subject;?></td>
                              <td class="hidden-xs hidden-md"><span><?php if(isset($value->queue->name)){ echo $value->queue->name;}?></span></td>
                              ...
                              <td class="hidden-xs hidden-md"><?php if(!isset($value->user->firstname)){echo '<span class="label">'.$this->lang->line('application_not_assigned').'</span>'; }else{ echo '<span class="label label-info">'.$value->user->firstname.' '.$value->user->lastname.'</span>'; }?></td>
