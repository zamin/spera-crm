  ...
  <div class="grid__col-md-7 dashboard-header">
      ...
      <div class="grid grid--align-content-start"> 
        ...
        <div class="grid__col-6 grid__col-xs-6 grid__col-sm-6 grid__col-md-6 grid__col-lg-3">
            <div class="tile-base tile-with-icon">
                  ...
                  <div class="tile-body">
                      <div class="number" id="number1"><?php if(empty($payments)){echo display_money(0, $core_settings->currency, 0);}else{echo display_money($payments, $core_settings->currency, 2); }?></div>
                  </div>
        ...
        <div class="grid__col-6 grid__col-xs-6 grid__col-sm-6 grid__col-md-6 grid__col-lg-3">
            <div class="tile-base"> 
                ...
                <div class="tile-body">
                    <div class="number" id="number2"><?php if(empty($paymentsoutstanding)){echo display_money(0, $core_settings->currency, 0);}else{echo display_money($paymentsoutstanding, $core_settings->currency, 2); } ?></div>
                </div>
                <div class="tile-bottom">   
        ...
        <div class="grid__col-6 grid__col-xs-6 grid__col-sm-6  grid__col-md-6 grid__col-lg-3">
            <a href="<?=base_url();?>aoprojects/filter/open" class="tile-base"> 
                                    ...
                                    <li class="<?=$value->status;?> priority<?=$value->priority;?> list-item">
                                        <span class="lbl-"> 
                                            <p class="truncate"><input name="form-field-checkbox" type="checkbox" class="checkbox-nolabel task-check" data-link="<?=base_url()?>projects/tasks/<?=$value->project_id;?>/check/<?=$value->id;?>" <?=$value->status;?>/>
                                                <a href="<?=base_url()?>aoprojects/view/<?=$value->project_id;?>"><?=$value->name;?></a>
                                            </p>
                                        </span> 
                                        <span class="pull-right hidden-xs" style="margin-top: -43px;">
                                              <a href="<?=base_url()?>aoprojects/tasks/<?=$value->project_id;?>/update/<?=$value->id;?>" class="edit-button" data-toggle="mainmodal"><i class="fa fa-cog"></i></a>
                                        </span>
                                    </li>
                                    <?php 
                                    endforeach;
        ...
        <div class="grid__col-12">
                    ...
                    <div class="stdpad stdpad--auto-height"><div class="table-head"><?=$this->lang->line('application_new_tickets');?></div>
                        <div class="table-div">
                            <table class="data-sorting table" id="aotickets" rel="<?=base_url()?>" cellspacing="0" cellpadding="0">
    <thead>
     
      <th style="width:70px"><?=$this->lang->line('application_ticket_id');?></th>
      <th class="hidden-xs" style="width:50px"><?=$this->lang->line('application_status');?></th>
    ...
    <?php endforeach;?>
        ...
        <div class="grid__col-sm-12 grid__col-md-4 grid__col-lg-3 grid__col--bleed">
           ...
           <div class="grid__col-12 ">
                      <div class="stdpad"><div class="table-head"><?=$this->lang->line('application_project_activities');?></div>
                        <div id="main-nano-wrapper" class="nano">
                          <div class="nano-content">
                                            ...
                                            <img class="userpic img-circle" src="
                                              ...
                                              <div class="pull-left" style="width: 78%;">
                                                  <p class="dash-messages__header truncate">
                                                      <?php if($value->status == "New"){ echo '<span class="new"><i class="fa fa-circle-o"></i></span>';}?> 
                                                      <?=$value->subject;?>
                                                  </p>
