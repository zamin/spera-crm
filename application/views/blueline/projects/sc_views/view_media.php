       ...
       <div class="col-xs-12 col-sm-3">
		...
		<div class="subcont">
			<ul class="details">
				...
				<li><span><?=$this->lang->line('application_download');?>:</span> <a href="<?=base_url()?>scprojects/download/<?=$media->id;?>" class="btn btn-xs btn-success"><i class="icon-download icon-white"></i> <?=$this->lang->line('application_download');?></a></li>
