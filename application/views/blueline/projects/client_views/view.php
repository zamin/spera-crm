                                ...
                                <li>
                                    ...
                                    <p class="activity__list--sub truncate">
                                        ...
                                        if (isset($value->user->id)) {
                                            echo $value->user->firstname . " " . $value->user->lastname . ' <a href="' . base_url() . 'cprojects/view/' . $value->project->id . '">' . $value->project->name . "</a>";
                                        }
                                        ?>
                                    </p>
...
//              if($value->created_by_client == $this->client->id){ $disable = "";} 
                        ...
                        <li id="task_<?php echo $value['id']; ?>" class="<?php echo $value['status']; ?> priority<?php echo $value['priority']; ?> list-item">
                            ...
                            <a href="<?php echo base_url() ?>cprojects/tasks/<?php echo $project->id; ?>/check/<?php echo $value['id']; ?>" class="ajax-silent task-check"></a>

                            <input name="form-field-checkbox" class="checkbox-nolabel task-check dynamic-reload" data-reload="tile-pie" type="checkbox" data-link="<?php echo base_url() ?>cprojects/tasks/<?= $project->id; ?>/check/<?= $value['id']; ?>" <?php
                        ...
                        ?> />
                            ...
                            <span class="pull-right">
                                ...
                                <span class="list-button">
                                    <a class="edit-button" href="<?= base_url(); ?>cprojects/tasks/<?= $project->id ?>/update/<?= $value['id'] ?>" data-toggle="mainmodal">
                                        <i class="ion-android-settings"></i>
                                    </a>
                                    <a  class="edit-button" href="<?= base_url(); ?>cprojects/tasks/<?= $project->id ?>/view/<?= $value['id'] ?>">
                                        <i class="fa fa-paperclip"></i>
                                    </a>
                                    <a  class="edit-button" href="<?= base_url(); ?>cprojects/tasks/<?= $project->id ?>/comment/<?= $value['id'] ?>">
    ...
    <?php //}  ?>
                        <ul class="details">
                            ...
                            <li>
                                ...
                                <a href="<?= base_url(); ?>cprojects/timesheets/<?= $value['id']; ?>" class="timer__icon_button tt" data-original-title="<?= $this->lang->line('application_timesheet'); ?>" data-toggle="mainmodal">
                            ...
                            <li>
                                ...
                                <a href="#" data-name="progress" class="editable synced-process-edit" data-syncto="progress-bar<?= $value['id']; ?>" data-type="range" data-pk="<?= $value['id']; ?>" data-url="<?= base_url() ?>cprojects/task_change_attribute"> 
                            <?= $value['progress']; ?>
                                </a> 
                            </li>
    ...
    <div class="row tab-pane fade" role="tabpanel" id="milestones-tab">
     <div class="col-xs-12 col-sm-12 col-lg-6">
            <div class="table-head"><?=$this->lang->line('application_milestones');?> 
                 <span class=" pull-right">
                      <a href="<?=base_url()?>cprojects/milestones/<?=$project->id;?>/add" class="btn btn-primary" data-toggle="mainmodal">
        ...
        <li id="milestoneLI_<?=$milestone->id;?>" class="hasItems">
            <h1 class="milestones__header ui-state-disabled">
               <i class="ion-android-list milestone__header__icon"></i>
                <?=$milestone->name;?>  
                <span class="pull-right"> 
                  <a href="<?=base_url()?>cprojects/milestones/<?=$milestone->project_id;?>/update/<?=$milestone->id;?>" data-toggle="mainmodal"><i class="ion-ios-gear milestone__header__right__icon"></i></a>
                  <a href="<?=base_url()?>cprojects/milestones/<?=$milestone->project_id;?>/view/<?=$milestone->id;?>" ><i class="fa fa-paperclip milestone__header__right__icon"></i></a>
                  <a href="<?=base_url()?>cprojects/milestones/<?=$milestone->project_id;?>/comment/<?=$milestone->id;?>" ><i class="fa fa-comment milestone__header__right__icon"></i></a>
                </span>      
            </h1>
            <ul id="milestonelist_<?=$milestone->id;?>" class="sortable-list">
                ...
                <li id="milestonetask_<?=$value->id;?>" class="<?=$value->status;?> priority<?=$value->priority;?> list-item">
                    ...
                    <input name="form-field-checkbox" class="checkbox-nolabel task-check dynamic-reload" data-reload="tile-pie" type="checkbox" data-link="<?=base_url()?>cprojects/tasks/<?=$project->id;?>/check/<?=$value->id;?>" <?php if($value->status == "done"){echo "checked";}?>/>
                    <span class="lbl">
                    ...
                    <a href="<?=base_url()?>cprojects/tasks/<?=$project->id;?>/update/<?=$value->id;?>" class="edit-button" data-toggle="mainmodal"><i class="fa fa-cog"></i></a>
                    <a class="edit-button" href="<?= base_url(); ?>cprojects/tasks/<?= $project->id ?>/view/<?= $value->id; ?>">
                        <i class="fa fa-paperclip"></i>
                    </a>
                    <a class="edit-button" href="<?= base_url(); ?>cprojects/tasks/<?= $project->id ?>/comment/<?= $value->id; ?>">
...
echo form_open(base_url().'cprojects/activity/' . $project->id . '/add', $attributes);
?>
...
<?php endforeach; ?>
    ...
    <div id="baseURL" class="hidden"><?= base_url(); ?>cprojects/index/<?php echo $this->sessionArr['company_id']; ?></div>
