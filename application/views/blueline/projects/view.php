  ...
  <div class="row tile-row tile-view">
      ...
      <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation" class="hidden-xs"><a href="#tasks-tab" id="task_menu_link" aria-controls="tasks-tab" role="tab" data-toggle="tab"><?php if($mytasks != 0){?><span class="badge"><?=$mytasks?></span><?php } ?><?=$this->lang->line('application_tasks');?></a></li>
       ...
       <?php } ?>
        ...
        <li role="presentation" class="dropdown visible-xs">
            ...
            <ul class="dropdown-menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents">
              ...
              <li role="presentation"><a href="#tasks-tab" aria-controls="tasks-tab" role="tab" data-toggle="tab"><?php if($mytasks != 0){?><span class="badge submenu-badge"><?=$mytasks?></span><?php } ?><?=$this->lang->line('application_tasks');?></a></li>
              ...
              <li role="presentation"><a href="#media-tab" aria-controls="media-tab"  class="media-tab-trigger" role="tab" data-toggle="tab"><?=$this->lang->line('application_media');?></a></li>
...
<div class="row tab-pane fade in active" role="tabpanel" id="projectdetails-tab">
                  ...
                  <ul class="details col-xs-12 col-sm-12">
                    ...
                    <li><span><?=$this->lang->line('application_start_date');?></span> <?php  $unix = human_to_unix($project->start.' 00:00'); echo date($core_settings->date_format, $unix);?></li>
            				...
            				<li><span><?php echo $this->lang->line('application_project'); ?> <?php echo $this->lang->line('application_time_spent');?></span> 
									<?php echo $time_spent;?> <a href="<?php echo base_url(); ?>projects/timer_reset/<?php echo $project->id;?>" class="tt" title="<?php echo $this->lang->line('application_reset_timer');?>"><i class="fa fa-refresh"></i></a> <a href="<?php echo base_url(); ?>projects/timer_set/<?php echo $project->id;?>" data-toggle="mainmodal" class="tt" title="<?php echo $this->lang->line('application_timer_set');?>"><i class="fa fa-clock-o"></i></a></li>
                                    ...
                                    <li>
                                        ...
                                        <p class="activity__list--sub truncate">
                                            <?php if(isset($value->user->id))
                                                  { 
                                                       echo $value->user->firstname." ".$value->user->lastname.' <a href="'.base_url().'projects'.$value->project->id.'">'.$value->project->name."</a>"; 
                                                  } ?>
                                        </p>
            ...
            <?php /*<div class="stdpad" > 
            <div class="table-head"><?=$this->lang->line('application_assigned_agents');?>
             <span class="pull-right"> 
                  <a href="<?=base_url()?>projects/assign/<?=$project->id;?>" class="btn btn-primary" style="padding: 2px 5px 3px;" data-toggle="mainmodal"><?=$this->lang->line('application_change_agents');?>
                  </a>
            </span>
     ...
     <div class="col-xs-12 col-sm-12 task-container-left">
            <div class="table-head"><?=$this->lang->line('application_tasks');?> 
                                        ...
                                        <span class="pull-right">
                                            ...
                                            <span class="list-button">
                                              <a id="dummy-href3" href="" data-toggle="mainmodal">
                                                    <i class="ion-android-settings" title="" ></i>
                                              </a>
                                            </span>    
                                        </span>
                        </li>
              ...
              $task_list = ($project->hide_tasks == 1 && $this->user->admin == 0) ? $allmytasks : $project->project_has_tasks;
				    ...
				    <li id="task_<?=$value->id;?>" class="<?=$value->status;?> priority<?=$value->priority;?> list-item <?php if($value->user_id == $this->user->id){echo "owntask";}?>">
              ...
              <input name="form-field-checkbox" class="checkbox-nolabel task-check dynamic-reload" data-reload="tile-pie" type="checkbox" data-link="<?=base_url()?>projects/tasks/<?=$project->id;?>/check/<?=$value->id;?>" <?php if($value->status == "done"){echo "checked";}?>/>
				    	...
				    	<span class="pull-right">
                                  <?php if ($value->tracking != 0) {  ?>
                                        <span class="list-button">
                                          <i class="ion-android-stopwatch tt" title="" data-original-title="<?=$this->lang->line('application_running_timer');?>"></i>
                                        </span>
                                  <?php } ?>
                                  <?php if ($value->public != 0) {  ?>
                                        <span class="list-button">
                                          <i class="ion-eye task__icon tt" title="" data-original-title="<?=$this->lang->line('application_task_public');?>"></i>
                                        </span>
                                  <?php } ?>
                                  ...
                                  <?php if ($value->user_id != 0) {  ?>
                                    <img class="img-circle list-profile-img tt"  title="<?=$value->user->firstname;?> <?=$value->user->lastname;?>"  src="<?=get_user_pic($value->user->userpic, $value->user->email);?>">
                                  <?php } ?>
                                  <?php if ($value->client_id != 0) {  ?>
                                    <img class="img-circle list-profile-img tt"  title="<?=$value->client->firstname;?> <?=$value->client->lastname;?>"  src="<?=get_user_pic($value->client->userpic, $value->client->email);?>">
                                  <?php } ?>
                        ...
                        <ul class="details">
                            ...
                            <li>
                                  ...
                                  <?php if($value->user_id != 0 && $value->user_id != ""){ 
                                    $pic = get_user_pic($value->user->userpic, $value->user->email); 
                                    echo "<img src=\"$pic\" class=\"img-circle list-profile-img \" height=\"21px\"> ";
                            ...
                            <?php if($value->start_date != ""){ ?>
                              <li>
                                  ...
                                  <?php  $unix = human_to_unix($value->start_date.' 00:00'); echo date($core_settings->date_format, $unix);?>
                              </li>
                            <?php } ?>
                            <?php if($value->due_date != ""){ ?>
                              <li> <?php $overdue = ($value->due_date < date("Y-m-d", time())) ? "label label-important" : ""; ?>
                                  ...
                                  <span class="<?=$overdue?>"><?php  $unix = human_to_unix($value->due_date.' 00:00'); echo date($core_settings->date_format, $unix);?></span>
                              </li>
                            <?php } ?>
                            ...
                            <?php } ?>
                              ...
                              <li>
                                 ...
                                 <!-- <a href="#" data-name="milestone_id" class="editable-select" data-type="select" data-pk="<?=$value->id;?>" data-url="<?=base_url()?>projects/task_change_attribute"> -->
                                  <?php if($value->milestone_id != 0 && $value->milestone_id != ""){ echo $value->project_has_milestone->name; }else{echo $this->lang->line('application_no_milestone_assigned');}?> <!--</a> -->
                              </li>
...
<div class="col-xs-12 col-sm-12">
    ...
    <?php /*<div class=" min-height-410 media-view-container">
...
<?php /*<div class="media-list-view-container hidden">*/?>
