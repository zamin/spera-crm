       ...
       <?php } ?>
        ...
        <li class="pull-right">
          <?php if(!empty($project->tracking)){ ?>
            ...
            <a href="<?=base_url()?>aoprojects/tracking/<?=$project->id;?>" class="tt red" title="<?=$this->lang->line('application_stop_timer');?>" ><span id="timerGlobal" class="badge"></span></a>
            <script>$( document ).ready(function() { startTimer("","<?=$timertime;?>", "#timerGlobal"); });</script>
          <?php }else{ ?>
            <a href="<?=base_url()?>aoprojects/tracking/<?=$project->id;?>" class="tt green" title="<?=$this->lang->line('application_start_timer');?>"><i class="fa fa-clock-o"></i> </a>
          <?php } ?>
       </li>
...
<div class="row tab-pane fade in active" role="tabpanel" id="projectdetails-tab">
            ...
            <div class="table-head"><?=$this->lang->line('application_project_details');?> <span class=" pull-right option-icon"> <a href="<?=base_url()?>aoprojects/update/<?=$project->id;?>" data-toggle="mainmodal" data-target="#mainModal"><i class="fa fa-cog"></i></a></span></div>
                 ...
                 <div class="subcont">
                  <ul class="details col-xs-12 col-sm-12">
                    ...
                    <li><span><?=$this->lang->line('application_start_date');?></span> <?php  $unix = human_to_unix($project->start.' 00:00'); echo date($core_settings->date_format, $unix);?></li>
                            ...
                            <li><span><?php echo $this->lang->line('application_project'); ?> <?php echo $this->lang->line('application_time_spent');?></span> 
                                    <?php echo $time_spent;?> <a href="<?php echo base_url(); ?>aoprojects/timer_reset/<?php echo $project->id;?>" class="tt" title="<?php echo $this->lang->line('application_reset_timer');?>"><i class="fa fa-refresh"></i></a> <a href="<?php echo base_url(); ?>aoprojects/timer_set/<?php echo $project->id;?>" data-toggle="mainmodal" class="tt" title="<?php echo $this->lang->line('application_timer_set');?>"><i class="fa fa-clock-o"></i></a></li>
                    <li><span><?php echo $this->lang->line('application_tasks');?> <?php echo $this->lang->line('application_time_spent');?></span> <?php echo Project::getAllTasksTime($project->id);?> </li>
                                    ...
                                    <li>
                                        ...
                                        <p class="activity__list--sub truncate">
                                            <?php if(isset($value->user->id))
                                                  { 
                                                       echo $value->user->firstname." ".$value->user->lastname.' <a href="'.base_url().'aoprojects/view/'.$value->project->id.'">'.$value->project->name."</a>"; 
                                                  } ?>
                                        </p>
     ...
     <div class="col-xs-12 col-sm-12  task-container-left">
           <div class="table-head"><?= $this->lang->line('application_tasks'); ?> 
                ...
                <!--<a class="btn btn-success toggle-closed-tasks tt" data-original-title="<?= $this->lang->line('application_hide_completed_tasks'); ?>" >
                    ...
                    <a href="<?= base_url() ?>aoprojects/tasks/<?= $project->id; ?>/add" class="btn btn-primary" data-toggle="mainmodal">
<?= $this->lang->line('application_add_task'); ?>
            ...
            <li id="task_<?php echo $value['id']; ?>" class="<?php echo $value['status']; ?> priority<?php echo $value['priority']; ?> list-item">
                            ...
                            <a href="<?php echo base_url() ?>aoprojects/tasks/<?php echo $project->id; ?>/check/<?php echo $value['id']; ?>" class="ajax-silent task-check"></a>

                            <input name="form-field-checkbox" class="checkbox-nolabel task-check dynamic-reload" data-reload="tile-pie" type="checkbox" data-link="<?php echo base_url() ?>aoprojects/tasks/<?= $project->id; ?>/check/<?= $value['id']; ?>" <?php if ($value['status'] == "done") {
                                echo "checked";
                            } ?> />
                            ...
                            <span class="pull-right">
                                ...
                                <span class="list-button">
                                    <a class="edit-button" href="<?= base_url(); ?>aoprojects/tasks/<?= $project->id ?>/update/<?= $value['id'] ?>" data-toggle="mainmodal">
                                        <i class="ion-android-settings"></i>
                                    </a>
                                    <a class="edit-button" href="<?= base_url(); ?>aoprojects/tasks/<?= $project->id ?>/view/<?= $value['id'] ?>">
                                        <i class="fa fa-paperclip"></i>
                                    </a>
                                    <a class="edit-button" href="<?= base_url(); ?>aoprojects/tasks/<?= $project->id ?>/comment/<?= $value['id'] ?>">
         ...
         <?php } ?>
            ...
            <div class="subcont taskviewer-content">
                ...
                <div id="task-details-<?=$value['id'];?>" class="todo-details">
                        ...
                        <?php if($value['tracking'] != 0 && $value['tracking'] != ""){ $start = "hidden"; $stop = ""; }else{$start = ""; $stop = "hidden";}?>
                          <a href="<?=base_url();?>aoprojects/task_start_stop_timer/<?=$value['id']; ?>" data-timerid="timer<?=$value['id'];?>" class="grid__col-6 grid__col--bleed center ajax-silent task__options__button task__options__button--green task__options__timer timer<?=$value['id'];?> <?=$start?>">
                              <?=$this->lang->line('application_start_timer');?>
                          </a>
                          
                          <a href="<?=base_url();?>aoprojects/task_start_stop_timer/<?=$value['id'];?>" data-timerid="timer<?=$value['id'];?>" class="grid__col-6 grid__col--bleed center ajax-silent task__options__button task__options__button--red task__options__timer timer<?=$value['id'];?> <?=$stop?>">
                              <?=$this->lang->line('application_stop_timer');?>
                          </a>
                            
                          <a href="<?=base_url();?>aoprojects/tasks/<?=$project->id?>/update/<?=$value['id']?>" class="grid__col-6 grid__col--bleed task__options__button" data-toggle="mainmodal">
                        ...
                        <ul class="details">
                            ...
                            <li>
                                ...
                                <a href="<?=base_url();?>aoprojects/timesheets/<?=$value['id'];?>" class="timer__icon_button tt" data-original-title="<?=$this->lang->line('application_timesheet');?>" data-toggle="mainmodal">
                            ...
                            <li>
                                  ...
                                  <a href="#" data-name="progress" class="editable synced-process-edit" data-syncto="progress-bar<?=$value['id'];?>" data-type="range" data-pk="<?=$value['id'];?>" data-url="<?=base_url()?>aoprojects/task_change_attribute"> 
                                  <?=$value['progress'];?>
                                  </a> 
                            </li>
                            ...
                            <?php if($value['due_date'] != ""){ ?>
                              <li>
                                  ...
                                  <?php  $unix = human_to_unix($value['due_date'].' 00:00'); echo date($core_settings->date_format, $unix);?>
                              </li>
                            <?php } ?>
                              <li>
     ...
     <div class="col-xs-12 col-sm-12 col-lg-6">
            <div class="table-head"><?=$this->lang->line('application_milestones');?> 
                 <span class=" pull-right">
                      <a href="<?=base_url()?>aoprojects/milestones/<?=$project->id;?>/add" class="btn btn-primary" data-toggle="mainmodal">
        ...
        <li id="milestoneLI_<?=$milestone->id;?>" class="hasItems">
            <h1 class="milestones__header ui-state-disabled">
               <i class="ion-android-list milestone__header__icon"></i>
                ...
                <?=$milestone->name?>  
                <span class="pull-right"> 
                  <a href="<?=base_url()?>aoprojects/milestones/<?=$milestone->project_id;?>/update/<?=$milestone->id;?>" data-toggle="mainmodal"><i class="ion-ios-gear milestone__header__right__icon"></i></a>
                  <a href="<?=base_url()?>aoprojects/milestones/<?=$milestone->project_id;?>/view/<?=$milestone->id;?>" ><i class="fa fa-paperclip milestone__header__right__icon"></i></a>
                  <a href="<?=base_url()?>aoprojects/milestones/<?=$milestone->project_id;?>/comment/<?=$milestone->id;?>" ><i class="fa fa-comment milestone__header__right__icon"></i></a>
                </span>      
            </h1>
            <ul id="milestonelist_<?=$milestone->id;?>" class="sortable-list">
                ...
                <li id="milestonetask_<?=$value->id;?>" class="<?=$value->status;?> priority<?=$value->priority;?> list-item">
                    <a href="<?=base_url()?>aoprojects/tasks/<?=$project->id;?>/check/<?=$value->id;?>" class="ajax-silent task-check"></a>
                    <input name="form-field-checkbox" class="checkbox-nolabel task-check dynamic-reload" data-reload="tile-pie" type="checkbox" data-link="<?=base_url()?>aoprojects/tasks/<?=$project->id;?>/check/<?=$value->id;?>" <?php if($value->status == "done"){echo "checked";}?>/>
                    <span class="lbl">
                    ...
                    <a href="<?=base_url()?>aoprojects/tasks/<?=$project->id;?>/update/<?=$value->id;?>" class="edit-button" data-toggle="mainmodal"><i class="fa fa-cog"></i></a>
                    <a class="edit-button" href="<?= base_url(); ?>aoprojects/tasks/<?= $project->id ?>/view/<?= $value->id; ?>">
                        <i class="fa fa-paperclip"></i>
                    </a>
                    <a class="edit-button" href="<?= base_url(); ?>aoprojects/tasks/<?= $project->id ?>/comment/<?= $value->id; ?>">
...
<div class="col-xs-12 col-sm-12">
 <div class="table-head"><?=$this->lang->line('application_media');?> <span class=" pull-right"><a href="<?=base_url()?>aoprojects/media/<?=$project->id;?>/add" class="btn btn-primary" data-toggle="mainmodal"><?=$this->lang->line('application_add_media');?></a></span></div>
<div class="table-div min-height-410">
 <table id="media" class="table data-media" rel="<?=base_url()?>aoprojects/media/<?=$project->id;?>" cellspacing="0" cellpadding="0">
        <thead>
        <tr>
                    <th  class="hidden"></th>
...
<?php $attributes = array('class' => 'note-form', 'id' => '_notes');
    echo form_open(base_url()."aoprojects/notes/".$project->id, $attributes); ?>
...
<div class="col-xs-12 col-sm-12">
            ...
            <ul id="comments-ul" class="comments">
                      ...
                      <?php   
                                ...
                                echo form_open(base_url().'aoprojects/activity/'.$project->id.'/add', $attributes); 
                                ?>
...
.circular-bar{
 ...
 <script type="text/javascript"> 
  ...
  <div id="baseURL" class="hidden"><?=base_url();?>aoprojects/index/<?php echo $this->sessionArr['company_id'];?></div>
