...
?>
                ...
                <td class="start_time">
                    <?php echo date($core_settings->date_format, $value->start); ?>

                </td>
                <td class="end_time">
                <?php echo date($core_settings->date_format, $value->end); ?>     
                </td>
...
<div class="modal-footer">
    <a id="timesheet_submit" class="btn btn-success" href="javascript:;"><?= $this->lang->line('application_save'); ?></a>
...
<script>
    $(document).ready(function () {
        $('#timesheet_submit').click(function () {
            ...
            var redirect_url = "<?php echo base_url(); ?>aoprojects/view/" + project_id + "#tasks-tab";
            if (hours != '00' || minutes != '00')
            {
                ...
                var ajax_url = "<?php echo base_url(); ?>aoprojects/timesheet_add_by_button";
                $.ajax({
                    type: "GET",
                    url: ajax_url,
                    cache:false,
