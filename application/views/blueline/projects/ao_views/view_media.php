       ...
       <div class="col-xs-12 col-sm-3">
		...
		<div class="subcont">
			<ul class="details">
				...
				<li><span><?=$this->lang->line('application_download');?>:</span> <a href="<?=base_url()?>aoprojects/download/<?=$media->id;?>" class="btn btn-xs btn-success"><i class="icon-download icon-white"></i> <?=$this->lang->line('application_download');?></a></li>
    	 ...
    	 <br>
    	 <a class="btn btn-primary" href="<?=base_url()?><?=$backlink;?>"><i class="fa fa-arrow-left"></i> <?=$this->lang->line('application_back_to_media');?></a>
    	 </div>
	 ...
	 <div class="col-sm-9">
	 		...
	 		<?php
				...
				case "image": ?>
					...
					<div align="center">
						<img src="<?=site_url()?>files/media/<?=$media->savename;?>">
					</div>
					</div>
				<?php 
				break; 
				case "application":
					...
					<video id="video" class="video-js vjs-default-skin" controls
				  		...
				  		<source src="<?=site_url()?>files/media/<?=$media->savename;?>" type='video/<?=$type[1];?>'>
					</video>
					</div>
					<?php } 
			        ...
			        <script type='text/javascript'>
					  ...
					  function embedPDF(){
					    ...
					    var myPDF = new PDFObject({ 
					      ...
					      url: '<?=site_url()?>/files/media/<?=$media->savename;?>'
			...
			case "audio":
					...
					<div class="subcont preview">
					<audio controls>
					  <source src="<?=site_url()?>files/media/<?=$media->savename;?>" type="audio/mpeg">
					</audio>
					</div>
