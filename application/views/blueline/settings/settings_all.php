...
<div class="row">
	...
	<div class="form-group">
		<label><?=$this->lang->line('application_logo');?> (max 160x200) <button type="button" class="btn-option po pull-right" data-toggle="popover" data-placement="right" data-content="<div class='logo' style='padding:10px'><img src='<?=$core_settings->logo;?>'></div>" data-original-title="<?=$this->lang->line('application_logo');?>"> <i class="ion-eye"></i></button>
		</label>
	...
	<div class="form-group">
		<label><?=$this->lang->line('application_invoice');?> <?=$this->lang->line('application_logo');?>  (max 160x200) <button type="button" class="btn-option po " data-toggle="popover" data-placement="right"  data-content="<div style='padding:10px'><img src='<?=$core_settings->invoice_logo;?>'></div>" data-original-title="<?=$this->lang->line('application_invoice');?> <?=$this->lang->line('application_logo');?>"> <i class="ion-eye"></i></button>
		</label>
                <div>
