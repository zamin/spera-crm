...
<div class="col-md-9">
		<div class="table-head"><?=$this->lang->line('application_all_packages');?> <span class="pull-right"><a href="<?=base_url()?>settings/user_create" class="btn btn-primary" data-toggle="mainmodal"><?=$this->lang->line('application_create_user');?></a></span></div>
		<div class="table-div">
		<table id="users" class="data-no-search table" cellspacing="0" cellpadding="0">
		<thead>
			<!--th style="width:10px"></th-->
			<th class="hidden-xs"><?=$this->lang->line('application_package_name');?></th>
			<!--th><?//=$this->lang->line('application_full_name');?></th-->
			<th class="hidden-xs"><?=$this->lang->line('application_package_status');?></th>
		...
		<tr id="<?=$package->id;?>">
			...
			<td class="hidden-xs"><?=$package->package_name;?></td>
			<!--td><?php //echo $user->firstname." ".$user->lastname;?></td-->
			<td class="hidden-xs"><?php if($package->status == '1') {echo 'Active';} else {echo 'Inactive';};?></td>
