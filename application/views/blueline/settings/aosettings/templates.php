<script type="text/javascript" src="<?=site_url()?>assets/blueline/js/plugins/ckeditor/ckeditor.js"></script>
<div id="row">
...
<div class="btn-group pull-right">
         ...
         <?php foreach ($template_files as $value) { ?>
         	 <li><a href="<?=base_url()?>aosettings/templates/<?=$value;?>"><?=$this->lang->line('application_'.$value.'_email_template');?></a></li>
        <?php } ?>
        </div>
</div>
<?php   
...
<a href="<?=base_url()?>aosettings/settings_reset/email_<?=$template;?>" class="btn btn-danger tt pull-right" title=""><i class="fa fa-refresh"></i> <?=$this->lang->line('application_reset_default');?></a>
</div>
