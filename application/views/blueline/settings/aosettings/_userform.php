...
<!-- <div class="form-group">
        ...
        <input id="username" type="hidden" name="username" class="required form-control"  value="<?php if(isset($user)){echo $user->username;} ?>"  required/>
</div> -->
<div class="form-group">
...
<div class="form-group">
        ...
        <input id="email" type="email" name="email" class="required email form-control" value="<?php if(isset($user)){echo $user->email;} ?>"  required readonly />
</div>
<div class="form-group">
...
<div class="form-group">
        ...
        if(isset($user->queue)){$queue = $user->queue;}else{$queue = "";}
