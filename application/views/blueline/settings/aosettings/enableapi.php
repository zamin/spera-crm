...
<div class="col-md-9">
	...
	<div class="row">
		...
		<!-- <input type="submit" name="submit" class="btn btn-primary" value="<?=$this->lang->line('application_reset_access_token');?>"/> -->
		<input type="button" class="btn btn-primary btn-option delete po" data-toggle="popover" data-placement="left" data-content="<button class='btn btn-danger' type='submit' name='submit' value='<?=$this->lang->line('application_yes_reset_access');?>'><?=$this->lang->line('application_yes');?></button> <button class='btn po-close'><?=$this->lang->line('application_no');?></button>" data-original-title="<b><?=$this->lang->line('application_access_token_reset');?></b>" value="<?=$this->lang->line('application_reset_access_token');?>">
		...
		<input type="button" class="btn btn-primary btn-option delete po" data-toggle="popover" data-placement="left" data-content="<button class='btn btn-danger' type='submit' name='submit' value='<?=$this->lang->line('application_yes_reset_both');?>'><?=$this->lang->line('application_yes');?></button> <button class='btn po-close'><?=$this->lang->line('application_no');?></button>" data-original-title="<b><?=$this->lang->line('application_all_token_reset');?></b>" value="<?=$this->lang->line('application_reset_all');?>">
