...
<div class="btn-group pull-right-responsive" style="margin-top: 9px;">
          <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
            <img src="<?=site_url()?>assets/blueline/img/<?php if($this->input->cookie('fc2language') != ""){echo $this->input->cookie('fc2language');}else{echo $default_language;} ?>.png" style="margin-top:-1px" align="middle"> <span class="caret"></span>
          </button>
          ...
          <?php if ($handle = opendir('application/language/')) {
									          ...
									          while (false !== ($entry = readdir($handle))) {
									              if ($entry != "." && $entry != "..") {
									                ?><li><a href="<?=base_url()?>quotation/language/<?=$entry;?>"><img src="<?=site_url()?>assets/blueline/img/<?=$entry;?>.png" class="language-img"><?=ucwords($entry);?></a></li>
                                  <?php } }
      									           closedir($handle);
      									          } ?>
