          ...
          <div class="row">
           ...
           <a href="<?=base_url()?>cinvoices/download/<?=$invoice->id;?>" class="btn btn-primary"><?=$this->lang->line('application_download_invoice');?></a>   
		   <div class="btn-group">
			  <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			    <?=$this->lang->line('application_invoice_payment');?> <span class="caret"></span>
			  </button>
			  <ul class="dropdown-menu">
			    <li><a href="<?=base_url()?>cinvoices/pullpropay/<?=$invoice->id;?>"><?=$this->lang->line('application_propay_to_propay_transfer');?></a></li>
			    <li><a href="<?=base_url()?>cinvoices/creditcardpay/<?=$invoice->id;?>"><?=$this->lang->line('application_pay_using_credit_card');?></a></li>
			  </ul>
			</div>
			</div>
          </div>
		...
		<ul class="details col-xs-12 col-sm-6">
			...
			<?php } ?>
			<li><span><?=$this->lang->line('application_project');?>:</span> <a href="<?=base_url()?>cprojects/view/<?=$invoice->project_id;?>" class="label label-info"><?=$invoice->project_name;?></a></li>
...
<div class=" col-md-12" align="right">
	...
	<div class="btn-group dropup">
	  ...
	  <?php if($core_settings->twocheckout == "1" && $core_settings->stripe == "0" && $core_settings->authorize_net == "0" && $sum != "0.00" && $invoice->status != "Paid" ){ ?>  
	    ...
	    <li><a id="pay_credit_card" data-toggle="mainmodal" href="<?=base_url()?>cinvoices/twocheckout/<?=$invoice->id;?>/<?=$sumRest;?>"><i class="fa fa-credit-card" style="margin-right:5px"></i> <?=$this->lang->line('application_credit_card');?></a></li>
	  <?php } ?>
