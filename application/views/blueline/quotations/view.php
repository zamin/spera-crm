			...
			<div class="col-md-6">
				...
				<div class="subcont">
					<ul class="details">
						...
						<li><span><?=$this->lang->line('application_worker');?>:</span> <?php if(isset($quotation->user->firstname)){echo $quotation->user->firstname." ".$quotation->user->lastname;}else{echo "-";}?></li>
