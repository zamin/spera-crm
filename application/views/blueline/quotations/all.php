			...
			<div class="btn-group pull-right-responsive margin-right-3">
		          ...
		          <ul class="dropdown-menu pull-right" role="menu">
		            <?php foreach ($submenu as $name=>$value):?>
			                <li><a id="<?php $val_id = explode("/", $value); if(!is_numeric(end($val_id))){echo end($val_id);}else{$num = count($val_id)-2; echo $val_id[$num];} ?>" href="<?php echo base_url().$value;?>"><?=$name?></a></li>
			            <?php endforeach;?>
		          </ul>
		      </div>
		...
		<?php endforeach;?>
	 	...
	 	<div id="options" class="row">
			...
			<div class="btn-group pull-right-responsive margin-right-3">
		          ...
		          <ul class="dropdown-menu pull-right" role="menu">
		            <?php foreach ($submenu2 as $name=>$value):?>
			                <li><a id="<?php $val_id = explode("/", $value); if(!is_numeric(end($val_id))){echo end($val_id);}else{$num = count($val_id)-2; echo $val_id[$num];} ?>" href="<?php echo base_url().$value;?>"><!-- #custom_quotations_requests_filter --><?=$name?></a></li>
			            <?php endforeach;?>
		          </ul>
		      </div>
			<script type="text/javascript">$(document).ready(function() { 
