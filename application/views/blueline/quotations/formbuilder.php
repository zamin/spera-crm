  <link rel="stylesheet" type="text/css" href="<?=site_url()?>assets/blueline/css/plugins/formbuilder.css" />
  <style>
  * {
...
<?php   
if(isset($quotation)){$qFormId = "/".$quotation->id;}else{$qFormId = "/false";}
...
?>
  ...
  <script type="text/javascript" src="<?=site_url()?>assets/blueline/js/plugins/formbuilder-vendor.js"></script>
  <script type="text/javascript" src="<?=site_url()?>assets/blueline/js/plugins/formbuilder.js"></script>
