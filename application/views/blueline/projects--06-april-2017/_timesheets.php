        ...
        <tbody id="newRows">
                ...
                <?php endforeach; ?>
                    ...
                    <input type="hidden" name="project_id" value="<?=$task->project_id;?>">
                            ...
                            <td>
                                <input class="inline-textfield datepicker-time start_time" type="text" value="" data-altInputClass="inline-textfield" data-altFormat="Y-m-d h:i" data-dateFormat="U" name="start" data-enableTime>
                            </td>
                            <td>
                                <input class="inline-textfield datepicker-time end_time" type="text" value="" data-altFormat="Y-m-d h:i"  name="end" data-altInputClass="inline-textfield" data-dateFormat="U" data-enableTime>   
                            </td>
...
<script>
            printDivCSS =  new String ('<link rel="stylesheet" href="<?=site_url()?>assets/blueline/css/bootstrap.min.css" />')
