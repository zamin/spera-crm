<?php   
$attributes = array('class' => 'dynamic-form', 'data-reload' => 'task-list', 'data-reload2' => 'milestones-list', 'data-baseurl' => base_url(), 'id' => '_milestone','enctype' => "multipart/form-data");
...
<div class="form-group">
        ...
        <div class="modal-footer">
          <?php if(isset($milestone)){ ?>
            <a href="<?=base_url()?>aoprojects/milestones/<?=$milestone->project_id;?>/delete/<?=$milestone->id;?>" class="btn btn-danger pull-left button-loader" ><?=$this->lang->line('application_delete');?></a>
          <?php }else{  ?>
