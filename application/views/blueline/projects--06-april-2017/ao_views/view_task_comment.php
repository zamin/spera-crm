...
<span class=" pull-right btn-backp"><a class="btn btn-primary" href="<?=base_url()?><?=$backlink;?>"><i class="fa fa-arrow-left"></i> <?=$this->lang->line('application_back_to_project');?></a><a class="btn btn-primary open-comment-box"><?=$this->lang->line('application_new_comment');?></a></span>
  </div> 
  <div class="subcont" > 
  <ul id="comments-ul" class="comments">
    <li class="comment-item add-comment">
      <?php   
                ...
                echo form_open(base_url().'aoprojects/tasks/'.$task->project_id.'/comment/'.$task->id, $attributes); 
                ?>
