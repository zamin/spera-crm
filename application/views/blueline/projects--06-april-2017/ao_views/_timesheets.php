...
<div id="printtimesheet">
    ...
    <?php
    $attributes = array('class' => 'dyanmic-form', 'id' => '_time');
        ...
        <tbody id="newRows">
            <?php foreach ($timesheets as $value): ?>
                ...
                <tr>
                    ...
                    <td>
                    <?php echo date($core_settings->date_format . ' ' . $core_settings->date_time_format, strtotime($value->start)); ?>
                    </td>
                    <td>
                    <?php echo date($core_settings->date_format . ' ' . $core_settings->date_time_format, strtotime($value->end)); ?>     
                    </td>
                    <td>
                    ...
                    <td>
                        <?php if ($this->user->id == $value->user_id) { ?>
                            <a href="<?= base_url() ?>aoprojects/timesheet_delete/<?= $value->id; ?>" class="deleteThisRow ajax-silent" title="<?= $this->lang->line('application_delete'); ?>"><i class="ion-close-circled red"></i></a>    
                    <?php } ?>
                    </td>
...
?>
                ...
                <td class="start_time">
                    <?php echo date($core_settings->date_format . ' ' . $core_settings->date_time_format, $value->start); ?>

                </td>
                <td class="end_time">
                <?php echo date($core_settings->date_format . ' ' . $core_settings->date_time_format, $value->end); ?>     
                </td>
        ...
        <td>
            <a href="#" class="add-row-ajax" title="<?= $this->lang->line('application_save'); ?>"><i class="ion-plus-circled"></i></a> <span class="delete_link hidden"><?= base_url() ?>aoprojects/timesheet_delete/</span>
