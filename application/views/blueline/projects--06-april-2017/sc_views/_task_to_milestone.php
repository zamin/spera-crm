...
<div class="form-group">
        ...
        <div class="modal-footer">
          <?php if(isset($milestone)){ ?>
            <a href="<?=base_url()?>scprojects/milestones/<?=$milestone->project_id;?>/delete/<?=$milestone->id;?>" class="btn btn-danger pull-left button-loader" ><?=$this->lang->line('application_delete');?></a>
          <?php }else{  ?>
