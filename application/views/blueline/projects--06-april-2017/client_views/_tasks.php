...
<div class="form-group">
    ...
    <input id="name" type="text" name="name" class="form-control resetvalue" value="<?php
    if (isset($task)) {
        echo $task->name;
    }
    ?>"  required/>
...
//$contact = array();
//$contacts['0'] = '-';
//foreach ($get_workers as $workers):
//    $contacts[$workers->id] = $workers->firstname . ' ' . $workers->lastname;
//endforeach;
//if (isset($task)) {
//    $contact = $task->client_id;
//} else {
//    $contact = $this->client->id;
//}
...
<div class="form-group">
    ...
    <input id="value" type="text" name="value" class="form-control decimal" value="<?php
        if (isset($task)) {
            echo $task->value;
        }
        ?>" />
...
<div class="form-group">
    ...
    <input class="form-control datepicker not-required" name="due_date" id="due_date" type="text" value="<?php
           if (isset($task)) {
               echo $task->due_date;
           }
        ?>" />
...
<div class="form-group">
    ...
    <textarea class="input-block-level summernote-modal"  id="textfield" name="description"><?php
    if (isset($task)) {
