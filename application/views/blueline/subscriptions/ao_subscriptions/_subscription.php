...
<div class="form-group">
<p id="recurring">
    <label for="recurring"><?=$this->lang->line('application_package');?></label>
    <?php
         //echo $package_type;exit;
            ...
            //echo form_dropdown('package_id', $options, $c, 'style="width:100%" id="package_id" class="required chosen-select" required onchange="funGettoken()"');
        ?>
</p>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    ?>
    <input id="Amount" type="text" name="Amount" required class="required form-control" readonly="readonly" value="<?php echo $y_main_amount;?>"/>
</div> */?> 
<div class="form-group">
