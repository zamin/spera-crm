	 ...
	 <div class="col-xs-12 col-md-9">
	 			...
	 			<a id="fadein" class="btn btn-success" style="margin-top: -2px;"><?=$this->lang->line('application_reply_back');?></a>
	 		 	<div class="btn-group nav-tabs hidden-xs">
	                ...
	                <a class="btn btn-primary backlink" id="back" href="<?=base_url()?>sctickets"><?=$this->lang->line('application_back');?></a>
	                <a class="btn btn-primary" id="note" data-toggle="mainmodal" href="<?=base_url()?>sctickets/article/<?=$ticket->id;?>/add"><?=$this->lang->line('application_add_note');?></a>
	                <a class="btn btn-primary" id="queue" data-toggle="mainmodal" href="<?=base_url()?>sctickets/queue/<?=$ticket->id;?>"><?=$this->lang->line('application_queue');?></a>
	                <a class="btn btn-primary" id="type" data-toggle="mainmodal" href="<?=base_url()?>sctickets/type/<?=$ticket->id;?>"><?=$this->lang->line('application_type');?></a>
	                <a class="btn btn-primary" id="assign" data-toggle="mainmodal" href="<?=base_url()?>sctickets/assign/<?=$ticket->id;?>"><?=$this->lang->line('application_assign');?></a> 
  					<a class="btn btn-primary" id="status" data-toggle="mainmodal" href="<?=base_url()?>sctickets/status/<?=$ticket->id;?>"><?=$this->lang->line('application_status');?></a>
  					<a class="btn btn-primary" id="close" data-toggle="mainmodal" href="<?=base_url()?>sctickets/close/<?=$ticket->id;?>"><?=$this->lang->line('application_close');?></a>
	        ...
	        <div class="btn-group pull-right visible-xs">
			  ...
			  <ul class="dropdown-menu" role="menu">
				...
				<li><a id="note" data-toggle="mainmodal" href="<?=base_url()?>sctickets/article/<?=$ticket->id;?>/add"><?=$this->lang->line('application_add_note');?></a></li>
				<li><a id="queue" data-toggle="mainmodal" href="<?=base_url()?>sctickets/queue/<?=$ticket->id;?>"><?=$this->lang->line('application_queue');?></a></li>
				<li><a id="type" data-toggle="mainmodal" href="<?=base_url()?>sctickets/type/<?=$ticket->id;?>"><?=$this->lang->line('application_type');?></a></li>
				<li><a id="assign" data-toggle="mainmodal" href="<?=base_url()?>sctickets/assign/<?=$ticket->id;?>"><?=$this->lang->line('application_assign');?></a></li>
			  	<li><a id="close" data-toggle="mainmodal" href="<?=base_url()?>sctickets/close/<?=$ticket->id;?>"><?=$this->lang->line('application_close');?></a></li>
			  </ul>
			</div>
	        ...
	        <div class="message-content-reply fadein no-padding">
					    ...
					    echo form_open(base_url().'sctickets/article/'.$ticket->id.'/add', $attributes); 
					    ?>
