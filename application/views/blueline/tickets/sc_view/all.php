    ...
    <div class="row"> 
			<a href="<?=base_url()?>sctickets/create" class="btn btn-primary" data-toggle="mainmodal"><?=$this->lang->line('application_create_new_ticket');?></a>
            <?php /*
            ...
            */
            ...
            <div class="btn-group pull-right margin-right-3">
                  ...
                  <ul class="dropdown-menu pull-right" role="menu">
                    <li><a href="<?=base_url().'sctickets/filter/all';?>">All</a></li>
                    <?php foreach ($statuslist as $name=>$value):?>
                          <li><a id="<?php $val_id = explode("/", $name);?>" href="<?=base_url().'sctickets/filter/'.$name;?>"><?=$name?></a></li>
                      <?php endforeach;?>
                  </ul>
              </div>
	...
	<div class="row">
		...
		<div class="table-div">
        <form action="<?php echo base_url().'sctickets/bulk';?>" method="post" name="frm_bulk" id="frm_bulk">
		...
		<tr id="<?=$value['id'];?>" >
            ...
            <td class="option" width="8%">
                ...
                <a href="<?=base_url()?>sctickets/update/<?=$value['id'];?>" class="btn-option" data-toggle="mainmodal"><i class="fa fa-cog"></i></a>
                <?php }?>
             </td>
