...
<?=form_open($form_action, $attributes)?>
       ...
       <div class="form-group">
            ...
            <input type="emailid" class="form-control" id="emailid" name="emailid" placeholder="<?=$this->lang->line('application_enter_your_username');?>" />
          </div>
          ...
          <input type="submit" class="btn btn-primary" id="submitbutton" value="<?=$this->lang->line('application_login');?>" />
