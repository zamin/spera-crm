<?php 
  $attributes = array('class' => 'message_form', 'id' => '_message');
  echo form_open_multipart($form_action, $attributes);
?>
<div class="form-group">
  <label for="name"><?=$this->lang->line('application_to');?></label><br>
  <select name="recipient" class="chosen-select" placeholder="<?php echo $this->lang->line('application_clients');?>" required>
...
<div class="form-group">
  ...
  <textarea class="input-block-level summernote-modal"  id="textfield" name="message" required></textarea>
</div>
