    ...
    <ul>
             ...
             <li>
                <div class="btn-group btn-message-menu">
                     <a class="btn btn-primary message-list-load inbox-folder active" id="message-trigger" role="button" href="<?=base_url()?>cmessages/messagelist" title="Inbox"><i class="fa fa-inbox space"></i> <span class="hidden-xs"><?=$this->lang->line('application_INBOX');?></span></a>
