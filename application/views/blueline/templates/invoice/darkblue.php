...
<body>
<?php if(!isset($htmlPreview)){ ?>
<div id="footer"><b><?=$core_settings->company;?></b> | <?=$core_settings->email;?><?php if($core_settings->invoice_tel != ""){echo " | ".$core_settings->invoice_tel;};?><?php if($core_settings->vat != ""){echo " | ".$this->lang->line('application_vat').": ".$core_settings->vat;}?> <br> Test test test   </div>
<?php } ?>
...
<div>
    ...
    <div class="custom-terms"><?php echo $invoice->terms; ?></div>
      <?php if(isset($htmlPreview)){ ?>
<div id="footer"><b><?=$core_settings->company;?></b> | <?=$core_settings->email;?><?php if($core_settings->invoice_tel != ""){echo " | ".$core_settings->invoice_tel;};?><?php if($core_settings->vat != ""){echo " | ".$this->lang->line('application_vat').": ".$core_settings->vat;}?>   </div>
<?php } ?>
