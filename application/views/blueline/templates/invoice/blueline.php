...
<body>
<?php if(!isset($htmlPreview)){ ?>
<div id="footer"><b><?=$invoice->company->name;?></b> | <?=$company_detail->email;?><?php if($company_detail->phone != ""){echo " | ".$company_detail->phone;};?><?php if($company_detail->vat != ""){echo " | ".$this->lang->line('application_vat').": ".$company_detail->vat;}?>   </div>
<?php } ?>
<div class="top-background">
   <table width="100%" cellspacing="0" >
         <tr>
           <td><img src="<?php if( $core_settings->pdf_path == 1 ) {echo site_url(); } ?><?=$core_settings->invoice_logo;?>" class="company-logo" /></td>
         ...
         <tr>
			...
			<?php */ ?>
            <td class="left" style="vertical-align:top"><?=$invoice->company->name;?></td>
        </tr> 
		<?php /* ?>
        <tr>
            <td style="vertical-align:top"><?=$core_settings->invoice_contact;?></td>
            <td class="left" style="vertical-align:top"><strong><?php if(isset($invoice->company->client->firstname)){ ?> <?=$invoice->company->client->firstname;?> <?=$invoice->company->client->lastname;?></strong><?php } ?></td>
        </tr>
		<?php */ ?>
        <tr>
			<?php /* ?>
        ...
        <tr>
          ...
          <span class="invoicereference"><?=$this->lang->line('application_invoice');?> <?=$core_settings->invoice_prefix;?><?=$invoice->reference;?><?=$project;?></span><br/>
...
<div class="content">
  ...
  <tr class="header"> 
    ...
    <th width="9%" class="center"><?=$this->lang->line('application_hours').':'.$this->lang->line('application_minutes');?></th>
