    ...
    <div class="content-area" onclick="">
      ...
      <div class="topbar__left noselect">
          ...
          <i class="ion-earth topbar__icon fc-dropdown--trigger"><?php if($notification_count > 0){ ?><span class="topbar__icon_alert"></span><?php } ?></i>
            ...
            <i class="ion-ios-stopwatch topbar__icon fc-dropdown--trigger"><?php if($task_notifications){ ?><span class="topbar__icon_alert"></span><?php } ?></i>
      ...
      <span class="topbar__name fc-dropdown--trigger">
          <span class="hidden-xs"><?php echo character_limiter($this->user->firstname." ".$this->user->lastname, 25);?></span> <i class="ion-chevron-down" style="padding-left: 2px;"></i>
      </span>
