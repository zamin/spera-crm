...
class Settings extends MY_Controller
{
	function __construct()
	{
		...
		$this->view_data['submenu'] = array(
				 		$this->lang->line('application_settings') => base_url().'settings',
				 		$this->lang->line('application_templates') => base_url().'settings/templates',
				 		$this->lang->line('application_pdf_templates') => base_url().'settings/invoice_templates',
				 		$this->lang->line('application_calendar') => base_url().'settings/calendar',
				 		$this->lang->line('application_paypal') => base_url().'settings/paypal',
				 		$this->lang->line('application_payment_gateways') => base_url().'settings/payment_gateways',
				 		$this->lang->line('application_bank_transfer') => base_url().'settings/bank_transfer',
				 		$this->lang->line('application_users') => base_url().'settings/users',
				 		$this->lang->line('application_registration') => base_url().'settings/registration',
				 		$this->lang->line('application_system_updates') => base_url().'settings/updates',
				 		$this->lang->line('application_backup') => base_url().'settings/backup',
				 		$this->lang->line('application_cronjob') => base_url().'settings/cronjob',
				 		$this->lang->line('application_ticket') => base_url().'settings/ticket',
				 		$this->lang->line('application_customize') => base_url().'settings/customize',
				 		$this->lang->line('application_theme_options') => base_url().'settings/themeoptions',
				 		$this->lang->line('application_smtp_settings') => base_url().'settings/smtp_settings',
				 		$this->lang->line('application_logs') => base_url().'settings/logs',
	...
	function index()
	{
		...
		$this->view_data['form_action'] = base_url().'settings/settings_update';
		...
		$this->view_data['breadcrumb_sub_id'] = $template;
				...
				if($_POST){
						...
						$this->session->set_flashdata('message', 'success:'.$this->lang->line('messages_save_template_success'));
				 		...
				 		$this->view_data['settings'] = Setting::first();
						$this->view_data['form_action'] = base_url().'settings/templates/'.$template;
	...
	function invoice_templates($dest = false, $template = FALSE){
		...
		if($_POST){
				...
				if($dest && $template){
						...
						$this->view_data['form_action'] = base_url().'settings/invoice_templates/'.$template;
	...
	function paypal(){
		...
		$this->session->set_flashdata('message', 'success:'.$this->lang->line('messages_save_settings_success'));
 		...
 		$this->view_data['settings'] = Setting::first();
		$this->view_data['form_action'] = base_url().'settings/paypal';
	...
	function calendar(){
		...
		$this->session->set_flashdata('message', 'success:'.$this->lang->line('messages_save_settings_success'));
 		...
 		$this->view_data['settings'] = Setting::first();
		$this->view_data['form_action'] = base_url().'settings/calendar';
	...
	function payment_gateways(){
		...
		$this->session->set_flashdata('message', 'success:'.$this->lang->line('messages_save_settings_success'));
 		...
 		$this->view_data['settings'] = Setting::first();
		$this->view_data['form_action'] = base_url().'settings/payment_gateways';
	...
	function bank_transfer(){
		...
		$this->session->set_flashdata('message', 'success:'.$this->lang->line('messages_save_settings_success'));
 		...
 		$this->view_data['settings'] = Setting::first();
		$this->view_data['form_action'] = base_url().'settings/bank_transfer';
	...
	function cronjob(){
		...
		$this->session->set_flashdata('message', 'success:'.$this->lang->line('messages_save_settings_success'));
 		...
 		$this->view_data['settings'] = Setting::first();
		$this->view_data['form_action'] = base_url().'settings/cronjob';
	...
	function ticket(){
		...
		$this->view_data['form_action'] = base_url().'settings/ticket';
	...
	function ticket_type($id = FALSE, $condition = FALSE){
		if($condition == "delete"){
			...
			$this->view_data['form_action'] = base_url().'settings/ticket_type/'.$id;
	...
	function ticket_queue($id = FALSE, $condition = FALSE){
		if($condition == "delete"){
			...
			$this->view_data['form_action'] = base_url().'settings/ticket_queue/'.$id;
	...
	function customize(){
		...
		$this->view_data['form_action'] = base_url().'settings/customize';
	...
	function registration()
	{
        ...
        $this->view_data['settings'] = Setting::first();
        $this->view_data['form_action'] = base_url().'settings/registration';
	...
	function users()
	{
		...
		$this->content_view = base_url().'settings/user';
	}
	
	function package()
	{
		$this->view_data['breadcrumb'] = $this->lang->line('application_user_packages');
		$this->view_data['breadcrumb_id'] = "packages";

		$options = array('conditions' => array('is_deleted != ?', '1'));
		$packages = Package::all($options);
		$this->view_data['packages'] = $packages;
		$this->content_view = 'settings/package';
	}
	...
	function user_create()
	{
		...
		}else
		{
			...
			$this->view_data['queues'] = Queue::find('all',array('conditions' => array('inactive=?','0')));
			$this->view_data['form_action'] = base_url().'settings/user_create/';
	...
	function user_update($user = FALSE){
		...
		$this->session->set_flashdata('message', 'success:'.$this->lang->line('messages_save_user_success'));
 		redirect('settings/users');
			...
			$this->view_data['form_action'] = base_url().'settings/user_update/'.$user->id;
			$this->content_view = 'settings/_userform';
 		}
	...
	function logs($val = FALSE){
		...
		if($val == "clear"){
 		...
 		$this->view_data['settings'] = Setting::first();
		$this->view_data['form_action'] = base_url().'settings/logs';
	...
	function themeoptions($val = FALSE){
		...
		$this->view_data['form_action'] = base_url().'settings/themeoptions';
	...
	function mysql_restore(){
		...
		@unlink($backup.".gzip");
	 	redirect('settings/updates');
			...
			$this->view_data['form_action'] = base_url().'settings/mysql_restore';
	...
	$config["bcc_batch_size"]   = 200;
		...
		$this->view_data['form_action'] = base_url().'settings/smtp_settings';
