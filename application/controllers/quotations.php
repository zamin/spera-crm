...
class Quotations extends MY_Controller {
	...
	function index()
	{
		...
		if($this->user->admin == 1){ 
			...
			$this->view_data['quotations'] = Quote::find('all', array('conditions' => array('user_id = '.$login_user_id)));
			$this->view_data['custom_quotations'] = Quoterequest::find('all', array('conditions' => array('user_id = '.$login_user_id)));
		}
	...
	function filter($condition)
	{
		...
		switch ($condition) {
			case 'new':
				$this->view_data['quotations'] = Quote::find('all', array('conditions' => array('status = "New" and user_id = '.$login_user_id)));
				break;
			case 'reviewed':
				$this->view_data['quotations'] = Quote::find('all', array('conditions' => array('status = "reviewed" and user_id = '.$login_user_id)));
				break;
			case 'accepted':
				$this->view_data['quotations'] = Quote::find('all', array('conditions' => array('status = "accepted" and user_id = '.$login_user_id)));
				break;
			default:
				$this->view_data['quotations'] = Quote::find('all', array('conditions' => array('user_id = '.$login_user_id)));
				break;
	...
	function customfilter($condition)
	{
		...
		switch ($condition) {
			case 'new':
				$this->view_data['custom_quotations'] = Quoterequest::find('all', array('conditions' => array('status = "New" and user_id = '.$login_user_id)));
				break;
			case 'reviewed':
				$this->view_data['custom_quotations'] = Quoterequest::find('all', array('conditions' => array('status = "reviewed" and user_id = '.$login_user_id)));
				break;
			case 'accepted':
				$this->view_data['custom_quotations'] = Quoterequest::find('all', array('conditions' => array('status = "accepted" and user_id = '.$login_user_id)));
				break;
			default:
				$this->view_data['custom_quotations'] = Quoterequest::find('all', array('conditions' => array('user_id = '.$login_user_id)));
				break;
	...
	{
		$login_user_id = $this->user->id;
		$this->view_data['quotations'] = Quoterequest::find('all', array('conditions' => array('user_id = '.$login_user_id)));
		$this->content_view = 'quotations/custom_all';
	}
	function quoteforms()
	{
		$login_user_id = $this->user->id;
		$this->view_data['quotations'] = Customquote::find('all', array('conditions' => array('user_id = '.$login_user_id)));
	...
	function cview($id = FALSE)
	{
		...
		$this->view_data['quotation'] = Quoterequest::find('all', array('conditions' => array('id = '.$id.' and user_id = '.$login_user_id)));
		//print_r($this->view_data['quotation']);die;
