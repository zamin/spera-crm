...
/**
 * ClassName: SubContractor Dashboard
 * Function Name: index 
 * This class is used for Sub-Contractor dashboard
 * */
if (!defined('BASEPATH'))
    exit('No direct script access allowed');

class Scdashboard extends MY_Controller {
    ...
    //Sub Contractor role activities
    function index($year=False) {
        ...
        if (in_array("scprojects", $this->module_permissions)) {
...
';
       ...
       //get new tickets
        ...
        $this->content_view = 'dashboard/subcdashboard';
    }
